...
Revision ID: 086462ccbfe6
Revises: 
Create Date: 2022-04-01 00:15:06.768495
...
def upgrade():
    ...
    sa.Column('title', sa.String(), nullable=True, comment='模块/权限名称'),
    sa.Column('key', sa.String(), nullable=True, comment='唯一编码'),
    sa.Column('flag', sa.String(), nullable=True, comment='类型 module:模块 button:操作'),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('domain', sa.String(), nullable=True, comment='域名'),
    ...
    sa.Column('name', sa.String(), nullable=True, comment='字典名'),
    sa.Column('sort', sa.Integer(), server_default='100', nullable=True, comment='顺序'),
    sa.Column('remark', sa.String(), nullable=True, comment='备注'),
    sa.Column('status', sa.Integer(), server_default='1', nullable=True, comment='状态 1.正常 2.禁用'),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('is_del', sa.Integer(), server_default='0', nullable=True, comment='逻辑删除:0=未删除,1=删除'),
    sa.Column('account', sa.String(), nullable=True, comment='操作人'),
    sa.Column('name', sa.String(), nullable=True, comment='日志名称'),
    sa.Column('opType', sa.Integer(), nullable=True, comment='操作类型'),
    sa.Column('className', sa.String(), nullable=True, comment='api模块'),
    sa.Column('methodName', sa.String(), nullable=True, comment='api方法'),
    sa.Column('url', sa.String(), nullable=True, comment='请求url'),
    sa.Column('param', sa.Text(), nullable=True, comment='请求参数'),
    sa.Column('reqMethod', sa.Text(), nullable=True, comment='请求方法'),
    sa.Column('authorization', sa.String(), nullable=True, comment='认证请求头'),
    sa.Column('userAgent', sa.String(), nullable=True, comment='用户代理'),
    sa.Column('browser', sa.String(), nullable=True, comment='浏览器'),
    sa.Column('os', sa.String(), nullable=True, comment='操作系统'),
    sa.Column('ip', sa.String(), nullable=True, comment='IP地址'),
    sa.Column('location', sa.String(), nullable=True, comment='地址'),
    sa.Column('result', sa.Text(), nullable=True, comment='返回信息'),
    sa.Column('message', sa.String(), nullable=True, comment='消息'),
    sa.Column('success', sa.String(), nullable=True, comment='是否成功'),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('is_del', sa.Integer(), server_default='0', nullable=True, comment='逻辑删除:0=未删除,1=删除'),
    sa.Column('account', sa.String(), nullable=True, comment='访问用户'),
    sa.Column('name', sa.String(), nullable=True, comment='日志名称'),
    ...
    sa.Column('code', sa.String(), nullable=True, comment='唯一编码'),
    sa.Column('value', sa.String(), nullable=True, comment='值'),
    sa.Column('sort', sa.Integer(), server_default='100', nullable=True, comment='顺序'),
    sa.Column('remark', sa.String(), nullable=True, comment='备注'),
    ...
    sa.Column('code', sa.String(), nullable=True, comment='唯一编码'),
    sa.Column('name', sa.String(), nullable=True, comment='组织名称'),
    sa.Column('sort', sa.Integer(), server_default='100', nullable=True, comment='顺序'),
    sa.Column('remark', sa.String(), nullable=True, comment='备注'),
    sa.Column('status', sa.Integer(), server_default='1', nullable=True, comment='状态 1.正常 2.禁用'),
    sa.Column('is_del', sa.Integer(), server_default='0', nullable=True, comment='逻辑删除:0=未删除,1=删除'),
    ...
    sa.Column('fullname', sa.String(), nullable=True, comment='姓名'),
    sa.Column('nickname', sa.String(), nullable=True, comment='昵称'),
    sa.Column('hashed_password', sa.String(), nullable=True, comment='密码'),
    ...
    sa.Column('mobile', sa.String(), nullable=True, comment='手机号'),
    sa.Column('status', sa.Integer(), server_default='1', nullable=True, comment='状态 1.正常 2.禁用'),
