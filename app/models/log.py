...
class VisitLog(Base):
    ...
    visType = Column(Integer, comment="访问类型")
    ...
    success = Column(String, comment="是否成功")

    visTime = Column(DateTime, comment="访问时间")
...
class OperateLog(Base):
    ...
    name = Column(String, comment="日志名称")
    opType = Column(Integer, comment="操作类型")
    ...
    opTime = Column(DateTime, comment="操作时间")
